...
const AGENT_PLAYBOOK: string[] = [
  "Read describe_project when the request depends on what is there now, or when the potter has just connected; an absolute edit can go straight to update_design, which returns the same snapshot. When session.paired is false, offer the create_live_handoff link as \"Open a paired browser session with this chat\" first, and the six-character code (join_session) as the alternative.",
